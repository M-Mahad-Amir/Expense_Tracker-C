...
A **console-based Expense Tracker application written in C**, developed as a **Final Semester Project for Programming Fundamentals**. The project focuses on applying core C concepts to solve a real-world problem: **personal expense and income management with persistent storage**.
